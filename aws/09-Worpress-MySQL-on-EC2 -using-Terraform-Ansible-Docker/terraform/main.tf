...
resource "aws_instance" "my_mysql_instance" {
  ami           = "ami-053b0d53c279acc90" # This is Ubuntu v22 AMI. Replace with your desired AMI
  instance_type = "t2.micro"              # Replace with your desired instance type
...
output "my_wp_instance_public_ip" {
  value = aws_instance.my_wp_instance.public_ip
}

output "my_mysql_instance_public_ip" {
  value = aws_instance.my_mysql_instance.public_ip
}
